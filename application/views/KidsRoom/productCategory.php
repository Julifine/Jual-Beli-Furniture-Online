...
<script>
									...
									if(childData.type == "user"){
										...
										for(var i=0;i<elements.length;i++){
											document.getElementById("content-item-"+i).onclick = function() {
												...
												window.location = '<?=base_url();?>KidsroomCatalogue/detailProduct/'+sub+"/"+this.dataset.tags;
											};
										}
									}else{
										...
										for(var i=0;i<elements.length;i++){
											document.getElementById("content-item-"+i).onclick = function() {
												//console.log(this.dataset.tags);
												window.location = '<?=base_url();?>KidsroomCatalogue/detailProductAdmin/'+sub+"/"+this.dataset.tags;
											};
										}
									}
								}
	...
	function stringSplit(kata_kata){
		...
		return toOtherPage('<?=base_url();?>KidsroomCatalogue/addProduct/'+newString);
	}
</script>