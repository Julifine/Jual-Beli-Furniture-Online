                  ...
                  <input type="hidden" name="email" data-form-email="true" value="">
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-12 input-group-btn">
							<a href="javascript:toOtherPage('<?= base_url();?>KitchenCatalogue/roomProduct/<?=$productCategory?>')" id="btn-cancel" class="btn btn-primary btn-form-product display-4" style="margin-right: 10px;background-color: #808080!important;border:#808080 solid!important;color: white!important;border-radius: 20px!important">CANCEL</a>
